...
import fondo_home from '../images/Laura.webp';
    ...
    <Contenedor_Home className='hero'>
      ...
      <div className='content'>
        ...
        <div className='bottom'>
          ...
          <p className='bottom-labels escribeme'>ESCRIBEME <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
